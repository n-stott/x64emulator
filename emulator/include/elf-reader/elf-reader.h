...
namespace elf {
    ...
    inline std::unique_ptr<Elf> ElfReader::tryCreate(const std::string& filename) {
    ...
    inline std::unique_ptr<Elf32> ElfReader::tryCreate32(const std::string& filename, std::vector<char> bytes, Identifier ident) {
        FileHeader32 header;
    ...
    inline std::unique_ptr<Elf64> ElfReader::tryCreate64(const std::string& filename, std::vector<char> bytes, Identifier ident) {
        FileHeader64 header;
    ...
    inline bool ElfReader::tryCreateIdentifier(const std::vector<char>& bytes, Identifier* ident) {
    ...
    inline bool ElfReader::tryCreateFileheader32(const std::vector<char>& bytes, const Identifier& ident, FileHeader32* header) {
    ...
    inline bool ElfReader::tryCreateFileheader64(const std::vector<char>& bytes, const Identifier& ident, FileHeader64* header) {
        if(!header) return false;
    ...
    inline std::unique_ptr<ProgramHeader32> ElfReader::tryCreateProgramheader32(const std::vector<char>& bytebuffer, size_t entryOffset, size_t entrySize) {
    ...
    inline std::unique_ptr<ProgramHeader64> ElfReader::tryCreateProgramheader64(const std::vector<char>& bytebuffer, size_t entryOffset, size_t entrySize) {
        if(bytebuffer.size() < entryOffset + entrySize) return {};
        const char* buffer = bytebuffer.data() + entryOffset;
    ...
    inline std::unique_ptr<SectionHeader32> ElfReader::tryCreateSectionheader32(const std::vector<char>& bytebuffer, size_t entryOffset, size_t entrySize) {
        if(bytebuffer.size() < entryOffset + entrySize) return {};
        const char* buffer = bytebuffer.data() + entryOffset;
    ...
    inline std::unique_ptr<SectionHeader64> ElfReader::tryCreateSectionheader64(const std::vector<char>& bytebuffer, size_t entryOffset, size_t entrySize) {
        if(bytebuffer.size() < entryOffset + entrySize) return {};
        const char* buffer = bytebuffer.data() + entryOffset;
