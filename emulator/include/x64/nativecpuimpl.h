...
namespace x64 {
    ...
    struct NativeCpuImpl {
        ...
        [[nodiscard]] static u128 rcpps(u128 src);
        ...
        [[nodiscard]] static u128 cvtps2pd(u128 src);
        ...
        [[nodiscard]] static u64 pmulhrsw64(u64 dst, u64 src);
        [[nodiscard]] static u128 pmulhrsw128(u128 dst, u128 src);

        [[nodiscard]] static u64 pabsb64(u64 src);
        [[nodiscard]] static u64 pabsw64(u64 src);
        [[nodiscard]] static u64 pabsd64(u64 src);
        [[nodiscard]] static u128 pabsb128(u128 src);
        ...
        [[nodiscard]] static u128 pmaxsb(u128 dst, u128 src);
        [[nodiscard]] static u128 pmaxsd(u128 dst, u128 src);
        ...
        [[nodiscard]] static u128 pmovsxbw(u64 src);
        [[nodiscard]] static u128 pmovsxbd(u32 src);
        [[nodiscard]] static u128 pmovsxbq(u16 src);
        [[nodiscard]] static u128 pmovsxwd(u64 src);
        [[nodiscard]] static u128 pmovsxwq(u32 src);
        [[nodiscard]] static u128 pmovsxdq(u64 src);
        ...
        [[nodiscard]] static u8 pextrb(u128 src, u8 order);
        ...
        [[nodiscard]] static u128 blendps(u128 dst, u128 src, u8 mask);
        [[nodiscard]] static u128 blendpd(u128 dst, u128 src, u8 mask);
