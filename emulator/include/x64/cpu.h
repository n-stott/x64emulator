...
namespace x64 {
    ...
    public:
        ...
        void exec(NativeExecPtr jitEntrypoint, NativeExecPtr nativeBasicBlock, u64* ticks, void** currentlyExecutingBasicBlockPtr, const void* currentlyExecutingJitBasicBlock);
