...
namespace x64::ir {
    ...
    public:
        ...
        void add(R8 dst, u8 imm);
        void add(R16 dst, R16 src);
        void add(R16 dst, u16 imm);
        void add(R32 dst, R32 src);
        void add(R32 dst, u32 imm);
        ...
        void sub(R64 dst, u32 imm);
        void sbb(R8 dst, R8 src);
        void sbb(R8 dst, u8 imm);
        void sbb(R32 dst, R32 src);
        void sbb(R32 dst, u32 imm);
        void sbb(R64 dst, R64 src);
        void sbb(R64 dst, u32 imm);
        void cmp(R8 lhs, R8 rhs);
        void cmp(R8 dst, u8 imm);
        void cmp(R16 lhs, R16 rhs);
        void cmp(R16 dst, u16 imm);
        void cmp(R32 lhs, R32 rhs);
        void cmp(R32 dst, u32 imm);
        void cmp(R64 lhs, R64 rhs);
        void cmp(R64 dst, u32 imm);
        ...
        void and_(R8 dst, u8 imm);
        void and_(R16 dst, R16 src);
        void and_(R16 dst, u16 imm);
        void and_(R32 dst, R32 src);
        void and_(R32 dst, u32 imm);
        void and_(R64 dst, R64 src);
        void and_(R64 dst, u32 imm);
        void or_(R8 dst, R8 src);
        void or_(R8 dst, u8 imm);
        void or_(R16 dst, R16 src);
        void or_(R16 dst, u16 imm);
        void or_(R32 dst, R32 src);
        void or_(R32 dst, u32 imm);
        void or_(R64 dst, R64 src);
        void or_(R64 dst, u32 imm);
        void xor_(R8 dst, R8 src);
        void xor_(R8 dst, u8 imm);
        void xor_(R16 dst, R16 src);
        void xor_(R16 dst, u16 imm);
        void xor_(R32 dst, R32 src);
        void xor_(R32 dst, u32 imm);
        void xor_(R64 dst, R64 src);
        void xor_(R64 dst, u32 imm);
        void not_(R32 dst);
        void not_(R64 dst);
        void neg(R8 dst);
        void neg(R16 dst);
