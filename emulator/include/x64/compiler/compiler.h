...
namespace x64 {
    ...
    private:
        ...
        bool tryCompileMovsxR16RM8(R16, const RM8&);
        ...
        bool tryCompileSubRM8RM8(const RM8&, const RM8&);
        bool tryCompileSubRM8Imm(const RM8&, Imm);
        bool tryCompileSubRM16RM16(const RM16&, const RM16&);
        bool tryCompileSubRM16Imm(const RM16&, Imm);
        ...
        bool tryCompileLockXaddM32R32(const M32&, R32);
        bool tryCompileCwde();
        bool tryCompileCdqe();
        bool tryCompileCdq();
        bool tryCompileCqo();
        ...
        bool tryCompileRepStosM8R8(const M8&, R8);
        ...
        bool tryCompileMovssXmmXmm(XMM, XMM);
        ...
        bool tryCompileMovlpsM64Xmm(const M64&, XMM);
        ...
        bool tryCompileMinsdXmmM64(XMM, const M64&);
        ...
        bool tryCompileUnpckhpsXmmXmmM128(XMM, const XMMM128&);
        bool tryCompileUnpckhpdXmmXmmM128(XMM, const XMMM128&);
        bool tryCompileUnpcklpsXmmXmmM128(XMM, const XMMM128&);
        bool tryCompileUnpcklpdXmmXmmM128(XMM, const XMMM128&);
        ...
        bool tryCompileRoundpsXmmXmmImm(XMM, XMM, Imm);
        ...
        bool tryCompilePblendvbXmmXmmM128(XMM, const XMMM128&);
        ...
        void sub8Imm8(Reg dst, i8 imm);
        void sub16(Reg dst, Reg src);
        void sub16Imm16(Reg dst, i16 imm);
