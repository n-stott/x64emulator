...
namespace x64::ir {
    ...
    void IrGenerator::repstos8() {
        emit(Op::REPSTOS8).addImpactedRegister(R64::RDI)
    ...
    void IrGenerator::repmovs8() {
        emit(Op::REPMOVS8).addImpactedRegister(R64::RDI)
                           .addImpactedRegister(R64::RSI)
                           .addImpactedRegister(R64::RCX);
    }
    void IrGenerator::repmovs16() {
        emit(Op::REPMOVS16).addImpactedRegister(R64::RDI)
                           .addImpactedRegister(R64::RSI)
                           .addImpactedRegister(R64::RCX);
    }
    void IrGenerator::repmovs32() {
        emit(Op::REPMOVS32).addImpactedRegister(R64::RDI)
                           .addImpactedRegister(R64::RSI)
                           .addImpactedRegister(R64::RCX);
    }
    void IrGenerator::repmovs64() {
        emit(Op::REPMOVS64).addImpactedRegister(R64::RDI)
                           .addImpactedRegister(R64::RSI)
                           .addImpactedRegister(R64::RCX);
    }
    ...
    void IrGenerator::pmovmskb(R32 dst, MMX src) { emit(Op::PMOVMSKB, dst, src); }
    ...
    void IrGenerator::movss(XMM dst, XMM src) { emit(Op::MOVSS, dst, dst, src); }
    ...
    void IrGenerator::movlps(M64 dst, XMM src) { emit(Op::MOVLPS, dst, dst, src); }
    ...
    void IrGenerator::pextrw(R32 dst, XMM src, u8 imm) { emit(Op::PEXTRW, dst, dst, src, imm); }
    ...
    void IrGenerator::maxps(XMM dst, XMM src) { emit(Op::MAXPS, dst, dst, src); }
    void IrGenerator::minps(XMM dst, XMM src) { emit(Op::MINPS, dst, dst, src); }
    void IrGenerator::maxpd(XMM dst, XMM src) { emit(Op::MAXPD, dst, dst, src); }
    void IrGenerator::minpd(XMM dst, XMM src) { emit(Op::MINPD, dst, dst, src); }
    ...
    void IrGenerator::unpckhps(XMM dst, XMM src) { emit(Op::UNPCKHPS, dst, dst, src); }
    void IrGenerator::unpckhpd(XMM dst, XMM src) { emit(Op::UNPCKHPD, dst, dst, src); }
    void IrGenerator::unpcklps(XMM dst, XMM src) { emit(Op::UNPCKLPS, dst, dst, src); }
    void IrGenerator::unpcklpd(XMM dst, XMM src) { emit(Op::UNPCKLPD, dst, dst, src); }

    void IrGenerator::movddup(XMM dst, XMM src) { emit(Op::MOVDDUP, dst, src); }

    void IrGenerator::palignr(MMX dst, MMX src, u8 imm) { emit(Op::PALIGNR, dst, dst, src, imm); }
    void IrGenerator::phaddw(MMX dst, MMX src) { emit(Op::PHADDW, dst, dst, src); }
    void IrGenerator::phaddd(MMX dst, MMX src) { emit(Op::PHADDD, dst, dst, src); }
    void IrGenerator::pmaddubsw(MMX dst, MMX src) { emit(Op::PMADDUSBW, dst, dst, src); }
    void IrGenerator::pmulhrsw(MMX dst, MMX src) { emit(Op::PMULHRSW, dst, dst, src); }
    ...
    void IrGenerator::pmovzxbw(XMM dst, XMM src) { emit(Op::PMOVZXBW, dst, src); }
    void IrGenerator::roundps(XMM dst, XMM src, u8 imm) { emit(Op::ROUNDPS, dst, src, imm); }
