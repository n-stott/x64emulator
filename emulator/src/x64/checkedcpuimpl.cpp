...
namespace x64 {
    ...
    u128 CheckedCpuImpl::movddup128(u128 src) {
        return checkCall<u128>(&CpuImpl::movddup128, &NativeCpuImpl::movddup128, src);
    }

    u128 CheckedCpuImpl::addsubps(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::addsubps, &NativeCpuImpl::addsubps, dst, src);
    }

    u128 CheckedCpuImpl::addsubpd(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::addsubpd, &NativeCpuImpl::addsubpd, dst, src);
    }

    u128 CheckedCpuImpl::haddps(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::haddps, &NativeCpuImpl::haddps, dst, src);
    }

    u128 CheckedCpuImpl::haddpd(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::haddpd, &NativeCpuImpl::haddpd, dst, src);
    }
    ...
    u64 CheckedCpuImpl::phaddw64(u64 dst, u64 src) {
        return checkCall<u64>(&CpuImpl::phaddw64, &NativeCpuImpl::phaddw64, dst, src);
    }

    u128 CheckedCpuImpl::phaddw128(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::phaddw128, &NativeCpuImpl::phaddw128, dst, src);
    }

    u64 CheckedCpuImpl::phaddd64(u64 dst, u64 src) {
        return checkCall<u64>(&CpuImpl::phaddd64, &NativeCpuImpl::phaddd64, dst, src);
    }

    u128 CheckedCpuImpl::phaddd128(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::phaddd128, &NativeCpuImpl::phaddd128, dst, src);
    }

    u64 CheckedCpuImpl::pmaddubsw64(u64 dst, u64 src) {
        return checkCall<u64>(&CpuImpl::pmaddubsw64, &NativeCpuImpl::pmaddubsw64, dst, src);
    }

    u128 CheckedCpuImpl::pmaddubsw128(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::pmaddubsw128, &NativeCpuImpl::pmaddubsw128, dst, src);
    }

    u64 CheckedCpuImpl::pmulhrsw64(u64 dst, u64 src) {
        return checkCall<u64>(&CpuImpl::pmulhrsw64, &NativeCpuImpl::pmulhrsw64, dst, src);
    }

    u128 CheckedCpuImpl::pmulhrsw128(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::pmulhrsw128, &NativeCpuImpl::pmulhrsw128, dst, src);
    }

    u64 CheckedCpuImpl::pabsb64(u64 src) {
        return checkCall<u64>(&CpuImpl::pabsb64, &NativeCpuImpl::pabsb64, src);
    }

    u64 CheckedCpuImpl::pabsw64(u64 src) {
        return checkCall<u64>(&CpuImpl::pabsw64, &NativeCpuImpl::pabsw64, src);
    }

    u64 CheckedCpuImpl::pabsd64(u64 src) {
        return checkCall<u64>(&CpuImpl::pabsd64, &NativeCpuImpl::pabsd64, src);
    }

    u128 CheckedCpuImpl::pabsb128(u128 src) {
        return checkCall<u128>(&CpuImpl::pabsb128, &NativeCpuImpl::pabsb128, src);
    }

    u128 CheckedCpuImpl::pabsw128(u128 src) {
        return checkCall<u128>(&CpuImpl::pabsw128, &NativeCpuImpl::pabsw128, src);
    }
    ...
    u128 CheckedCpuImpl::pmovsxbw(u64 src) {
        return checkCall<u128>(&CpuImpl::pmovsxbw, &NativeCpuImpl::pmovsxbw, src);
    }

    u128 CheckedCpuImpl::pmovsxbd(u32 src) {
        return checkCall<u128>(&CpuImpl::pmovsxbd, &NativeCpuImpl::pmovsxbd, src);
    }

    u128 CheckedCpuImpl::pmovsxbq(u16 src) {
        return checkCall<u128>(&CpuImpl::pmovsxbq, &NativeCpuImpl::pmovsxbq, src);
    }

    u128 CheckedCpuImpl::pmovsxwd(u64 src) {
        return checkCall<u128>(&CpuImpl::pmovsxwd, &NativeCpuImpl::pmovsxwd, src);
    }

    u128 CheckedCpuImpl::pmovsxwq(u32 src) {
        return checkCall<u128>(&CpuImpl::pmovsxwq, &NativeCpuImpl::pmovsxwq, src);
    }

    u128 CheckedCpuImpl::pmovsxdq(u64 src) {
        return checkCall<u128>(&CpuImpl::pmovsxdq, &NativeCpuImpl::pmovsxdq, src);
    }
    ...
    u128 CheckedCpuImpl::roundss128(u128 dst, u128 src, u8 imm, SIMD_ROUNDING roundingMode) {
        return checkCall<u128>(&CpuImpl::roundss128, &NativeCpuImpl::roundss128, dst, src, imm, roundingMode);
    }

    u128 CheckedCpuImpl::roundsd64(u128 dst, u64 src, u8 imm, SIMD_ROUNDING roundingMode) {
        return checkCall<u128>(&CpuImpl::roundsd64, &NativeCpuImpl::roundsd64, dst, src, imm, roundingMode);
    }

    u128 CheckedCpuImpl::roundsd128(u128 dst, u128 src, u8 imm, SIMD_ROUNDING roundingMode) {
        return checkCall<u128>(&CpuImpl::roundsd128, &NativeCpuImpl::roundsd128, dst, src, imm, roundingMode);
    }

    u128 CheckedCpuImpl::pmulld(u128 dst, u128 src) {
        return checkCall<u128>(&CpuImpl::pmulld, &NativeCpuImpl::pmulld, dst, src);
    }

    u8 CheckedCpuImpl::pextrb(u128 src, u8 order) {
        return checkCall<u8>(&CpuImpl::pextrb, &NativeCpuImpl::pextrb, src, order);
    }
    ...
    u128 CheckedCpuImpl::pinsrb(u128 dst, u8 src, u8 order) {
        return checkCall<u128>(&CpuImpl::pinsrb, &NativeCpuImpl::pinsrb, dst, src, order);
    }

    u128 CheckedCpuImpl::pinsrd(u128 dst, u32 src, u8 order) {
        return checkCall<u128>(&CpuImpl::pinsrd, &NativeCpuImpl::pinsrd, dst, src, order);
    }

    u128 CheckedCpuImpl::pinsrq(u128 dst, u64 src, u8 order) {
        return checkCall<u128>(&CpuImpl::pinsrq, &NativeCpuImpl::pinsrq, dst, src, order);
    }
    ...
    u128 CheckedCpuImpl::blendps(u128 dst, u128 src, u8 mask) {
        return checkCall<u128>(&CpuImpl::blendps, &NativeCpuImpl::blendps, dst, src, mask);
    }

    u128 CheckedCpuImpl::blendpd(u128 dst, u128 src, u8 mask) {
        return checkCall<u128>(&CpuImpl::blendpd, &NativeCpuImpl::blendpd, dst, src, mask);
    }
    ...
    u128 CheckedCpuImpl::pblendvb(u128 dst, u128 src, u128 mask) {
    ...
    u128 CheckedCpuImpl::roundpd(u128 src, u8 imm, SIMD_ROUNDING roundingMode) {
