...
namespace utils {
    ...
    std::string X64Instruction::toString() const {
        switch(insn()) {
            ...
            case Insn::LOCK_INC_M8: return toString<RM8>("lock inc");
            case Insn::LOCK_INC_M16: return toString<RM16>("lock inc");
            case Insn::LOCK_INC_M32: return toString<RM32>("lock inc");
            case Insn::LOCK_INC_M64: return toString<RM64>("lock inc");
            ...
            case Insn::LOCK_DEC_M8: return toString<RM8>("lock dec");
            case Insn::LOCK_DEC_M16: return toString<RM16>("lock dec");
            case Insn::LOCK_DEC_M32: return toString<RM32>("lock dec");
            case Insn::LOCK_DEC_M64: return toString<RM64>("lock dec");
            ...
            case Insn::CVTSS2SI_R64_RSSE: return toString<R64, RSSE>("cvtss2si");
            ...
            case Insn::CVTSD2SI_R64_RSSE: return toString<R64, RSSE>("cvtsd2si");
            ...
            case Insn::CVTTPS2DQ_RSSE_RMSSE: return toString<RSSE, RMSSE>("cvttps2dq");
            ...
            case Insn::PINSRW_RSSE_R32_IMM: return toString<RSSE, R32, Imm>("pinsrw");
            case Insn::PINSRW_RSSE_M16_IMM: return toString<RSSE, M16, Imm>("pinsrw");
            ...
            case Insn::PADDSB_RSSE_RMSSE: return toString<RSSE, RMSSE>("paddsb");
            case Insn::PADDSW_RSSE_RMSSE: return toString<RSSE, RMSSE>("paddsw");
            case Insn::PADDUSB_RSSE_RMSSE: return toString<RSSE, RMSSE>("paddusb");
            case Insn::PADDUSW_RSSE_RMSSE: return toString<RSSE, RMSSE>("paddusw");
            ...
            case Insn::PSUBSB_RSSE_RMSSE: return toString<RSSE, RMSSE>("psubsb");
            case Insn::PSUBSW_RSSE_RMSSE: return toString<RSSE, RMSSE>("psubsw");
            case Insn::PSUBUSB_RSSE_RMSSE: return toString<RSSE, RMSSE>("psubusb");
            case Insn::PSUBUSW_RSSE_RMSSE: return toString<RSSE, RMSSE>("psubusw");
            case Insn::PMULHUW_RSSE_RMSSE: return toString<RSSE, RMSSE>("pmulhuw");
            case Insn::PMULHW_RSSE_RMSSE: return toString<RSSE, RMSSE>("pmulhw");
            ...
            case Insn::PAVGB_RSSE_RMSSE: return toString<RSSE, RMSSE>("pavgb");
            case Insn::PAVGW_RSSE_RMSSE: return toString<RSSE, RMSSE>("pavgw");
            ...
            case Insn::PSRAW_RSSE_IMM: return toString<RSSE, Imm>("psraw");
