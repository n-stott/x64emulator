...
namespace x64 {
    ...
    static X64Instruction makeInstruction(const ZydisDisassembledInstruction& insn) {
        switch(insn.info.mnemonic) {
            ...
            case ZYDIS_MNEMONIC_FSUB: return makeFsub(insn);
            ...
            case ZYDIS_MNEMONIC_CVTTPD2DQ: return makeCvttpd2dq(insn);
            ...
            case ZYDIS_MNEMONIC_HADDPS: return makeHaddps(insn);
            case ZYDIS_MNEMONIC_HADDPD: return makeHaddpd(insn);

            // SSSE 3
            case ZYDIS_MNEMONIC_PALIGNR: return makePalignr(insn);
            case ZYDIS_MNEMONIC_PHADDW: return makePhaddw(insn);
            ...
            case ZYDIS_MNEMONIC_PSIGNB: return makePsignb(insn);
            case ZYDIS_MNEMONIC_PSIGNW: return makePsignw(insn);
            case ZYDIS_MNEMONIC_PSIGND: return makePsignd(insn);

            // SSE4.1
            case ZYDIS_MNEMONIC_PMAXUW: return makePmaxuw(insn);
            ...
            case ZYDIS_MNEMONIC_PMOVSXBW: return makePmovsxbw(insn);
            case ZYDIS_MNEMONIC_PMOVSXBD: return makePmovsxbd(insn);
            case ZYDIS_MNEMONIC_PMOVSXBQ: return makePmovsxbq(insn);
            case ZYDIS_MNEMONIC_PMOVSXWQ: return makePmovsxwq(insn);
            case ZYDIS_MNEMONIC_PMOVSXWD: return makePmovsxwd(insn);
            case ZYDIS_MNEMONIC_PMOVSXDQ: return makePmovsxdq(insn);
