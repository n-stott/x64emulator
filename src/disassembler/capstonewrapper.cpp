...
namespace x64 {
    ...
    X64Instruction CapstoneWrapper::makeXadd(const cs_insn& insn) {
        ...
        auto rm64dst = asRM64(dst);
        auto r64src = asRegister64(src);
        if(rm16dst && r16src) return X64Instruction::make<Insn::XADD_RM16_R16>(insn.address, insn.size, rm16dst.value(), r16src.value());
        if(rm32dst && r32src) return X64Instruction::make<Insn::XADD_RM32_R32>(insn.address, insn.size, rm32dst.value(), r32src.value());
        if(rm64dst && r64src) return X64Instruction::make<Insn::XADD_RM64_R64>(insn.address, insn.size, rm64dst.value(), r64src.value());
        return make_failed(insn);
    }
    ...
    X64Instruction CapstoneWrapper::makeScas(const cs_insn& insn) {
        u8 prefixByte = insn.detail->x86.prefix[0];
        if(prefixByte == 0) return make_failed(insn);
        x86_prefix prefix = (x86_prefix)prefixByte;
        const auto& x86detail = insn.detail->x86;
    ...
    X64Instruction CapstoneWrapper::makeAddps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeAddpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeSubps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeSubpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeMulps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeMulpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeDivps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeDivpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeCvtsd2ss(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeCvttss2si(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeUnpckhps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeUnpckhpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeUnpcklps(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeUnpcklpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
    ...
    X64Instruction CapstoneWrapper::makeMovmskpd(const cs_insn& insn) {
        const auto& x86detail = insn.detail->x86;
        assert(x86detail.op_count == 2);
        const cs_x86_op& dst = x86detail.operands[0];
        const cs_x86_op& src = x86detail.operands[1];
