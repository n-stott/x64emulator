...
namespace utils {
    ...
    std::string X64Instruction::toString() const {
        switch(insn()) {
            ...
            case Insn::INC_R8: return toString<RM8>("inc");
            case Insn::INC_R16: return toString<RM16>("inc");
            case Insn::INC_R32: return toString<RM32>("inc");
            case Insn::INC_R64: return toString<RM64>("inc");
            case Insn::INC_M8: return toString<RM8>("inc");
            case Insn::INC_M16: return toString<RM16>("inc");
            case Insn::INC_M32: return toString<RM32>("inc");
            case Insn::INC_M64: return toString<RM64>("inc");
            ...
            case Insn::CMPXCHG_R8_R8: return toString<RM8, R8>("cmpxchg");
            case Insn::CMPXCHG_R16_R16: return toString<RM16, R16>("cmpxchg");
            case Insn::CMPXCHG_R32_R32: return toString<RM32, R32>("cmpxchg");
            case Insn::CMPXCHG_R64_R64: return toString<RM64, R64>("cmpxchg");
            case Insn::CMPXCHG_M8_R8: return toString<RM8, R8>("cmpxchg");
            case Insn::CMPXCHG_M16_R16: return toString<RM16, R16>("cmpxchg");
            case Insn::CMPXCHG_M32_R32: return toString<RM32, R32>("cmpxchg");
            case Insn::CMPXCHG_M64_R64: return toString<RM64, R64>("cmpxchg");
