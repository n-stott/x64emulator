...
namespace x64 {
    ...
    std::string X64Instruction::toString() const {
        switch(insn()) {
            ...
            case Insn::MOV_RM8_RM8:     return toString<RM8, RM8>("mov");
            case Insn::MOV_RM8_IMM:     return toString<RM8, Imm>("mov");
            case Insn::MOV_RM16_RM16:   return toString<RM16, RM16>("mov");
            case Insn::MOV_RM16_IMM:    return toString<RM16, Imm>("mov");
            case Insn::MOV_RM32_RM32:   return toString<RM32, RM32>("mov");
            case Insn::MOV_RM32_IMM:    return toString<RM32, Imm>("mov");
            case Insn::MOV_RM64_RM64:   return toString<RM64, RM64>("mov");
            case Insn::MOV_RM64_IMM:    return toString<RM64, Imm>("mov");
            case Insn::MOV_RMSSE_RMSSE: return toString<RMSSE, RMSSE>("mov");
